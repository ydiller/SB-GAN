...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        #parser.add_argument('--end2endtri', action='store_true', help='end-to-end model with 3 parts')
        parser.add_argument('--disp_nc', type=int, default=3, help='# of input disparity channels')
    ...
    def parse(self, save=False):
        ...
        print('semantic_nc = ', opt.semantic_nc)
        print('label_nc = ', opt.label_nc)
        # set gpu ids
